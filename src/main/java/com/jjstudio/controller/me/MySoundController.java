...
public class MySoundController {
    ...
    @ApiOperation(value = "Create a sound for current user", notes = "${MySoundController.createSound.notes}")
    @PostMapping
    ...
    @ApiOperation(value = "Get a sound for current user", notes = "${MySoundController.getSoundById.notes}")
    @GetMapping("/{id}")
    ...
    @ApiOperation(value = "Get all sounds for current user", notes = "${MySoundController.getAllSounds.notes}")
    @GetMapping
    ...
    @ApiOperation(value = "Delete a sound for current user", notes = "${MySoundController.deleteSoundById.notes}")
    @DeleteMapping("/{id}")
